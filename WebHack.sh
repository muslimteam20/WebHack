...
echo -e "\t${colors[rand1]} |__| |__||______| |_|   |_||___||_|  |__| |__| |__||__| |__||_______||___| |_|"
	...
	echo -e "                 \t${bd}${g}│${w} Tools Type ${b}:${w} Website Hack for Brute Force                          ${g}${n}"
	echo -e "                 \t${bd}${g}╭${w} Author  ${b}:${c} ${ul}MD Muntasir Maruf${n}          ${g}${n}"
	echo -e "                 \t${bd}${g}│${w} Version ${b}:${w} 0.1                          ${g}${n}"
	echo -e "                 \t${bd}${g}│${w} Code    ${b}:${w} Bash, python                   ${g}${n}"
echo -e "                 \t${bd}${g}│${w} FB Page ${b}:${w} Muslim_Team 2.0                          ${g}${n}"
	echo -e "     \t${bd}${g} ╭──────────────┴${w} Date    ${b}:${w} 27 08 2023                 ${g}${n}"
}
